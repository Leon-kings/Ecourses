...
//     if (activeModal === 'CourseDetail') return 'w-full max-w-6xl';
//     if (activeModal === 'video') return 'w-full max-w-6xl';
//     if (activeModal === 'pdf') return 'w-full max-w-5xl';
//     if (activeModal === 'quiz') return 'w-full max-w-3xl';
//     if (activeModal === 'assignment') return 'w-full max-w-3xl';
//     if (activeModal === 'enroll') return 'w-full max-w-4xl';
//     if (activeModal === 'learning') return 'w-full max-w-6xl';
...
//     //     <div className={`bg-gradient-to-r from-${course.color}-600 to-${course.color}-800 p-4 sm:p-6 md:p-8 sticky top-0 z-10`}>
//     //       <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
//     //         <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full">
//     //           <div className="text-4xl sm:text-5xl md:text-6xl">{course.image}</div>
//     //           <div className="flex-1">
//     //             <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
//     //               <span className={`px-2 sm:px-3 py-1 bg-${course.badgeColor}-500/20 text-${course.badgeColor}-400 rounded-full text-xs font-semibold`}>
//     //                 {course.badge}
//     //               </span>
//     //               <span className="flex items-center gap-1 text-white text-sm sm:text-base">
//     //                 <StarIcon className="w-4 h-4 text-yellow-400" />
//     //                 {course.rating} ({course.students.toLocaleString()})
//     //               </span>
//     //               {isEnrolled(course.id) && (
//     //                 <span className="px-2 sm:px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-xs font-semibold">
//     //                   Enrolled
//     //                 </span>
//     //               )}
...
//     //               </span>
//     //             </div>
//     //             <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">{course.title}</h2>
//     //             <p className="text-sm sm:text-base text-white/80 line-clamp-2 sm:line-clamp-none">{course.description}</p>
//     //           </div>
//     //         </div>
//     //       </div>

//     //       {/* Course Meta - Responsive Grid */}
//     //       <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6 mt-4 sm:mt-6 text-white text-sm sm:text-base">
//     //         <div className="flex items-center gap-2">
//     //           <PersonIcon className="w-4 h-4 flex-shrink-0" />
//     //           <span className="truncate">{course.instructor.split(' ')[0]}</span>
//     //         </div>
//     //         <div className="flex items-center gap-2">
//     //           <AccessTime className="w-4 h-4 flex-shrink-0" />
//     //           <span>{course.duration}</span>
//     //         </div>
//     //         <div className="flex items-center gap-2">
//     //           <MenuBookIcon className="w-4 h-4 flex-shrink-0" />
...
//     //             <TrendingUpIcon className="w-4 h-4 text-green-400 flex-shrink-0" />
//     //             <span className="text-green-400">{getCourseProgress(course.id)}%</span>
//     //           </div>
//     //         )}
//     //       </div>

//     //       {/* Free Preview Section - Responsive */}
//     //       {course.freePreview && (
//     //         <div className="mt-4 sm:mt-6 bg-white/10 rounded-xl p-3 sm:p-4">
...
//     //                 }
//     //               }}
//     //               className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white px-3 sm:px-4 py-2 rounded-lg text-sm transition-colors"
//     //             >
//     //               <PlayArrowIcon className="w-4 h-4" />
//     //               <span className="hidden sm:inline">Watch Free Video</span>
...
//     //                 }
//     //               }}
//     //               className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 rounded-lg text-sm transition-colors"
//     //             >
//     //               <PictureAsPdfIcon className="w-4 h-4" />
//     //               <span className="hidden sm:inline">View Free PDF</span>
...
//     //                 }
//     //               }}
//     //               className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-3 sm:px-4 py-2 rounded-lg text-sm transition-colors"
//     //             >
//     //               <QuizIcon className="w-4 h-4" />
//     //               <span className="hidden sm:inline">Try Free Quiz</span>
...
//     //               <span className="text-white/60 line-through ml-2">${course.originalPrice}</span>
//     //               <span className="ml-2 text-green-400 text-sm sm:text-base">{course.discount}% off</span>
//     //             </>
//     //           ) : (
//     //             <span className="text-xl sm:text-2xl font-bold text-green-400">You're enrolled!</span>
//     //           )}
//     //         </div>
...
//     //                 setActiveModal('enroll');
//     //               }}
//     //               className="flex-1 sm:flex-none bg-gradient-to-t from-green-600 to-green-400 text-white px-4 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:from-green-700 hover:to-green-500 transition-all duration-300 text-sm sm:text-base"
//     //             >
//     //               Enroll
//     //             </button>
//     //           ) : (
...
//     //                 setActiveModal('learning');
//     //               }}
//     //               className="flex-1 sm:flex-none bg-gradient-to-t from-blue-600 to-blue-400 text-white px-4 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-500 transition-all duration-300 text-sm sm:text-base"
//     //             >
//     //               Continue
//     //             </button>
//     //           )}
//     //           <button
//     //             onClick={() => setActiveModal(null)}
//     //             className="flex-1 sm:flex-none border-2 border-white text-white px-4 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-white/10 transition-all duration-300 text-sm sm:text-base"
//     //           >
//     //             Close
//     //           </button>
//     //         </div>
...
//     //             key={tab}
//     //             onClick={() => setActiveTab(tab)}
//     //             className={`px-3 sm:px-4 md:px-6 py-3 sm:py-4 font-semibold capitalize transition-colors text-xs sm:text-sm ${
//     //               activeTab === tab
//     //                 ? `text-${course.color}-400 border-b-2 border-${course.color}-400`
//     //                 : 'text-gray-400 hover:text-white'
//     //             }`}
...
//     //              tab === 'discussions' ? 'Discussions' : 'Announcements'}
//     //           </button>
//     //         ))}
//     //       </div>
//     //     </div>
...
//     //                 <div key={index} className="flex items-start gap-2">
//     //                   <CheckCircleIcon className={`text-${course.color}-400 w-4 h-4 sm:w-5 sm:h-5 mt-0.5 flex-shrink-0`} />
...
//     //             <ul className="list-disc list-inside text-sm sm:text-base text-gray-300 space-y-1 sm:space-y-2">
//     //               {course.requirements.map((req, index) => (
//     //                 <li key={index}>{req}</li>
//     //               ))}
//     //             </ul>
...
//     //           {/* Target Audience */}
//     //           <div>
//     //             <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">Who This Course Is For</h3>
//     //             <ul className="list-disc list-inside text-sm sm:text-base text-gray-300 space-y-1 sm:space-y-2">
//     //               {course.targetAudience.map((audience, index) => (
//     //                 <li key={index}>{audience}</li>
//     //               ))}
...
//     //                   [sectionIndex]: !prev[sectionIndex]
//     //                 }))}
//     //                 className="w-full p-3 sm:p-4 bg-gray-800 flex items-center justify-between hover:bg-gray-700 transition-colors"
//     //               >
//     //                 <div className="flex items-center gap-2 truncate pr-2">
//     //                   <MenuBookIcon className={`text-${course.color}-400 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0`} />
//     //                   <span className="text-sm sm:text-base text-white font-semibold truncate">{section.section}</span>
//     //                 </div>
//     //                 <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
//     //                   <span className="text-xs sm:text-sm text-gray-400">{section.lectures.length}</span>
//     //                   {expandedSections[sectionIndex] ?
//     //                     <KeyboardArrowUpIcon className="w-4 h-4 sm:w-5 sm:h-5" /> :
//     //                     <KeyboardArrowDownIcon className="w-4 h-4 sm:w-5 sm:h-5" />}
//     //                 </div>
//     //               </button>
...
//     //                       <div
//     //                         key={lectureIndex}
//     //                         className="p-3 sm:p-4 border-t border-gray-800 hover:bg-gray-800/50 flex items-center justify-between"
//     //                       >
//     //                         <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
//     //                           {lecture.type === 'video' && (
//     //                             lecture.free || isEnrolled(course.id) ?
//     //                               <PlayCircleIcon className="text-green-400 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" /> :
//     //                               <LockIcon className="text-gray-500 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />
//     //                           )}
//     //                           {lecture.type === 'pdf' && (
//     //                             lecture.free || isEnrolled(course.id) ?
//     //                               <PictureAsPdfIcon className="text-red-400 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" /> :
//     //                               <LockIcon className="text-gray-500 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />
//     //                           )}
//     //                           {lecture.type === 'quiz' && <QuizIcon className="text-purple-400 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />}
//     //                           {lecture.type === 'assignment' && <AssignmentIcon className="text-orange-400 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />}
//     //                           <div className="min-w-0">
//     //                             <span className="text-xs sm:text-sm text-white truncate block">{lecture.title}</span>
//     //                             <div className="flex flex-wrap items-center gap-1 sm:gap-2 mt-1">
//     //                               {lecture.type === 'video' && (
//     //                                 <span className="text-xs text-gray-400">{lecture.duration}</span>
//     //                               )}
//     //                               {lecture.type === 'quiz' && (
//     //                                 <span className="text-xs text-gray-400">{lecture.questions} questions</span>
//     //                               )}
//     //                               {watchedLectures[lecture.id] && (
...
//     //                               >
//     //                                 <PlayArrowIcon className="w-4 h-4 sm:w-5 sm:h-5" />
//     //                               </button>
//     //                             )}
//     //                             {lecture.type === 'pdf' && (
//     //                               <button
...
//     //                               >
//     //                                 <QuizIcon className="w-4 h-4 sm:w-5 sm:h-5" />
//     //                               </button>
//     //                             )}
//     //                             {lecture.type === 'assignment' && (
//     //                               <button
...
//     //       {activeTab === 'notes' && (
//     //         <div>
//     //           <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">Your Notes</h3>
//     //           <div className="space-y-3 sm:space-y-4">
//     //             {Object.keys(notes).length > 0 ? (
//     //               Object.entries(notes).map(([lectureId, lectureNotes]) => (
//     //                 <div key={lectureId} className="bg-gray-800 rounded-lg p-3 sm:p-4 border border-gray-700">
...
//     //                       <div className="flex justify-between text-xs text-gray-400 mb-1">
//     //                         <span>{note.timestamp}</span>
//     //                         <span>{Math.round(note.videoTimestamp)}%</span>
//     //                       </div>
//     //                       <p className="text-xs sm:text-sm text-gray-300">{note.content}</p>
//     //                     </div>
//     //                   ))}
//     //                 </div>
//     //               ))
//     //             ) : (
//     //               <p className="text-sm sm:text-base text-gray-400">No notes yet. Start watching and take notes!</p>
//     //             )}
//     //           </div>
//     //         </div>
//     //       )}
...
//     //       {activeTab === 'downloads' && (
//     //         <div>
//     //           <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">Course Downloads</h3>
//     //           <div className="grid gap-2 sm:gap-3">
//     //             {course.downloads.map((dl, index) => (
//     //               <div key={index} className="bg-gray-800 rounded-lg p-3 sm:p-4 border border-gray-700 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
//     //                 <div className="flex items-center gap-3">
//     //                   {dl.type === 'pdf' ? <PictureAsPdfIcon className="text-red-400 w-5 h-5 sm:w-6 sm:h-6" /> : <InsertDriveFileIcon className="text-blue-400 w-5 h-5 sm:w-6 sm:h-6" />}
//     //                   <div>
//     //                     <span className="text-sm sm:text-base text-white">{dl.title}</span>
//     //                     <span className="text-xs sm:text-sm text-gray-400 ml-2">({dl.size})</span>
//     //                     {dl.description && (
//     //                       <p className="text-xs text-gray-500 mt-1">{dl.description}</p>
//     //                     )}
//     //                     {dl.free && (
//     //                       <span className="mt-1 inline-block text-xs bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full">Free</span>
//     //                     )}
//     //                   </div>
//     //                 </div>
...
//     //                         title="Download"
//     //                       >
//     //                         <CloudDownloadIcon className="w-4 h-4 sm:w-5 sm:h-5" />
//     //                       </button>
//     //                     </>
//     //                   )}
//     //                   {!dl.free && !isEnrolled(course.id) && (
//     //                     <LockIcon className="text-gray-500 w-4 h-4 sm:w-5 sm:h-5" />
//     //                   )}
//     //                 </div>
//     //               </div>
//     //             ))}
...
//     //             <h3 className="text-lg sm:text-xl font-bold text-white">Discussions</h3>
//     //             {isEnrolled(course.id) && (
//     //               <button className="w-full sm:w-auto bg-gradient-to-t from-blue-600 to-blue-400 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:from-blue-700 hover:to-blue-500">
//     //                 New Discussion
//     //               </button>
//     //             )}
//     //           </div>
...
//     //                 <div className="flex justify-between mb-2">
//     //                   <span className="text-xs sm:text-sm text-blue-400">{disc.user}</span>
//     //                   <span className="text-xs text-gray-400">{disc.time}</span>
//     //                 </div>
//     //                 <p className="text-sm sm:text-base text-white mb-2">{disc.question}</p>
//     //                 <div className="flex items-center gap-2">
//     //                   <span className="text-xs sm:text-sm text-gray-400">{disc.replies} replies</span>
//     //                   <button className="text-blue-400 text-xs sm:text-sm hover:underline">Reply</button>
//     //                 </div>
//     //               </div>
//     //             ))}
//     //           </div>
...
//     //       {activeTab === 'announcements' && (
//     //         <div>
//     //           <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">Announcements</h3>
//     //           <div className="space-y-3 sm:space-y-4">
//     //             {course.announcements.map((ann, index) => (
//     //               <div key={index} className="bg-gray-800 rounded-lg p-3 sm:p-4 border border-gray-700">
//     //                 <div className="flex justify-between mb-2">
//     //                   <span className="text-sm sm:text-base font-semibold text-white">{ann.title}</span>
//     //                   <span className="text-xs text-gray-400">{ann.date}</span>
//     //                 </div>
//     //                 <p className="text-xs sm:text-sm text-gray-300">{ann.content}</p>
//     //               </div>
//     //             ))}
//     //           </div>
//     //         </div>
...
//     animate="visible"
//     exit="exit"
//     className={`bg-gradient-to-b from-gray-900 to-black rounded-2xl ${getModalWidthClass()} mx-4 overflow-hidden shadow-2xl border border-gray-800 max-h-[90vh] flex flex-col`}
//   >
//     {/* Scrollable Header - Not Sticky on Mobile */}
//     <div className="overflow-y-auto flex-1">
//       {/* Course Header - Not Sticky */}
//       <div className={`bg-gradient-to-r from-${course.color}-600 to-${course.color}-800 p-4 sm:p-6 md:p-8`}>
//         <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
//           <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full">
//             <div className="text-4xl sm:text-5xl md:text-6xl">{course.image}</div>
//             <div className="flex-1">
...
//               <button
//   onClick={() => {
//     if (!Array.isArray(course.downloads)) return;
...
//       <div className="border-b border-gray-800 overflow-x-auto sticky top-0 bg-gray-900 z-10">
//         <div className="flex min-w-max sm:min-w-0 px-2">
//           {['overview', 'curriculum', 'notes', 'downloads', 'discussions', 'announcements'].map((tab) => (
//             <button
//               key={tab}
//               onClick={() => setActiveTab(tab)}
//               className={`px-4 sm:px-6 py-3 sm:py-4 font-semibold capitalize transition-colors text-sm sm:text-base whitespace-nowrap ${
//                 activeTab === tab
//                   ? `text-${course.color}-400 border-b-2 border-${course.color}-400`
//                   : 'text-gray-400 hover:text-white'
//               }`}
...
//             <div className="grid gap-2 sm:gap-3">
//               {/* {course.downloads.map((dl, index) => ( */}
//               {Array.isArray(course.downloads) && course.downloads.map((dl, index) => (
//                 <div key={index} className="bg-gray-800 rounded-lg p-3 sm:p-4 border border-gray-700 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
//                   <div className="flex items-center gap-3">
//                     {dl.type === 'pdf' ? <PictureAsPdfIcon className="text-red-400 w-5 h-5 sm:w-6 sm:h-6" /> : <InsertDriveFileIcon className="text-blue-400 w-5 h-5 sm:w-6 sm:h-6" />}
//                     <div>
...
//           animate="visible"
//           exit="exit"
//           className={`bg-gradient-to-b from-gray-900 to-black rounded-2xl ${getModalWidthClass()} mx-4 overflow-hidden shadow-2xl border border-gray-800`}
//         >
//           <div className="flex flex-col lg:flex-row h-[90vh]">
//             {/* Video Player Section */}
//             <div className="lg:w-3/4 flex flex-col">
...
//                       animate={{ opacity: 1, y: 0 }}
//                       exit={{ opacity: 0, y: 20 }}
//                       className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-2 sm:p-4"
//                     >
//                       {/* Progress Bar */}
...
//                             className="text-white hover:text-blue-400 p-1"
//                           >
//                             <Replay10Icon className="w-4 h-4 sm:w-5 sm:h-5" />
//                           </button>
//                           <button
//                             onClick={() => {
//                               if (playerRef.current) {
...
//                             value={playbackRate}
//                             onChange={(e) => changePlaybackRate(parseFloat(e.target.value))}
//                             className="bg-gray-800 text-white text-xs sm:text-sm rounded px-1 sm:px-2 py-1 border border-gray-700"
//                           >
//                             <option value="0.5">0.5x</option>
//                             <option value="1">1x</option>
//                             <option value="1.25">1.25x</option>
...
//                 <h3 className="text-base sm:text-lg md:text-xl font-bold text-white">{lesson.title}</h3>
//                 <p className="text-xs sm:text-sm text-gray-400 mt-1">{lesson.description}</p>

//                 {/* Mark Complete Button */}
//                 {!lesson.free && isEnrolled(course.id) && !watchedLectures[lesson.id] && (
//                   <button
//                     onClick={() => markLectureCompleted(lesson.id)}
//                     className="mt-3 bg-gradient-to-t from-green-600 to-green-400 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-semibold hover:from-green-700 hover:to-green-500"
//                   >
//                     Mark as Completed
//                   </button>
//                 )}
...
//                 {/* Free Preview Notice */}
//                 {lesson.free && !isEnrolled(course.id) && (
//                   <div className="mt-3 text-xs sm:text-sm text-green-400">
//                     This is a free preview. Enroll to access the full course!
//                   </div>
//                 )}
//               </div>
...
//             <div className="lg:w-1/4 bg-gray-900 border-t lg:border-t-0 lg:border-l border-gray-800 flex flex-col h-64 lg:h-auto">
//               <div className="p-3 sm:p-4 border-b border-gray-800">
//                 <h4 className="font-semibold text-white flex items-center gap-2 text-sm sm:text-base">
//                   <DescriptionIcon className="text-blue-400 w-4 h-4 sm:w-5 sm:h-5" />
//                   Lecture Notes
//                 </h4>
//               </div>
...
//                       onChange={(e) => setNoteText(e.target.value)}
//                       placeholder="Take notes at current timestamp..."
//                       className="w-full px-3 py-2 bg-gray-800 border border-gray-700 text-white rounded-lg text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
//                       rows="3"
//                     ></textarea>
//                     <button
//                       onClick={saveNote}
//                       disabled={!noteText.trim()}
//                       className="w-full mt-2 bg-gradient-to-t from-blue-600 to-blue-400 text-white px-3 py-2 rounded-lg text-xs sm:text-sm font-semibold hover:from-blue-700 hover:to-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
//                     >
//                       Save Note at {formatTime(currentTime)}
//                     </button>
//                   </div>
...
//                 {/* Notes List */}
//                 <div className="space-y-3">
//                   <h5 className="text-xs sm:text-sm font-semibold text-gray-400">Saved Notes</h5>
//                   {lectureNotes.length > 0 ? (
//                     lectureNotes.map((note, index) => (
//                       <div key={note.id} className="bg-gray-800 rounded-lg p-2 sm:p-3 border border-gray-700">
//                         <div className="flex justify-between items-start mb-1">
//                           <button
//                             onClick={() => jumpToNote(note.timeSeconds)}
//                             className="text-xs text-blue-400 hover:underline"
...
//                     ))
//                   ) : (
//                     <p className="text-xs sm:text-sm text-gray-500">No notes yet for this lecture.</p>
//                   )}
//                 </div>
//               </div>
...
//                 <button
//                   onClick={() => setActiveModal(null)}
//                   className="w-full border-2 border-gray-700 text-gray-300 px-4 py-2 rounded-lg text-xs sm:text-sm font-semibold hover:bg-gray-800"
//                 >
//                   Close Player
//                 </button>
//               </div>
...
//           animate="visible"
//           exit="exit"
//           className={`bg-gradient-to-b from-gray-900 to-black rounded-2xl ${getModalWidthClass()} mx-4 overflow-hidden shadow-2xl border border-gray-800 h-[90vh] flex flex-col`}
//         >
//           {/* Header */}
//           <div className="bg-gray-800 p-3 sm:p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b border-gray-700">
//             <div className="flex items-center gap-3">
//               <PictureAsPdfIcon className="text-red-400 text-xl sm:text-2xl" />
//               <div>
//                 <h3 className="text-sm sm:text-base text-white font-semibold">{pdf.title}</h3>
//                 <p className="text-xs text-gray-400">PDF Document</p>
//               </div>
//             </div>
//             <div className="flex items-center gap-2 self-end sm:self-auto">
...
//               <div>
//                 <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white">{quiz.title}</h3>
//                 <p className="text-xs sm:text-sm text-gray-400">{questions.length} questions</p>
//                 {quiz.free && !isEnrolled(course.id) && (
//                   <span className="mt-1 inline-block text-xs bg-green-500/20 text-green-400 px-2 py-1 rounded-full">
//                     Free Preview
//                   </span>
...
//                   <TimerIcon className="text-yellow-400 w-4 h-4 sm:w-5 sm:h-5" />
//                   <span className={timeLeft < 300 ? 'text-red-400' : 'text-white'}>
//                     {formatTime(timeLeft)}
//                   </span>
//                 </div>
...
//                       setTimeLeft(quiz.duration ? parseInt(quiz.duration) * 60 : 900);
//                     }}
//                     className="bg-gradient-to-t from-blue-600 to-blue-400 text-white px-6 py-2 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-500 text-sm sm:text-base"
//                   >
//                     Retry Quiz
//                   </button>
//                   <button
//                     onClick={() => setActiveModal(null)}
//                     className="border-2 border-gray-600 text-gray-300 px-6 py-2 rounded-lg font-semibold hover:bg-gray-800 text-sm sm:text-base"
//                   >
//                     Close
//                   </button>
//                 </div>
...
//                           className="hidden"
//                         />
//                         <div className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 mr-3 flex items-center justify-center flex-shrink-0 ${
//                           answers[currentQuestionIndex] === optIndex
//                             ? 'border-blue-500 bg-blue-500'
//                             : 'border-gray-400'
//                         }`}>
...
//                     onClick={() => setCurrentQuestionIndex(prev => Math.max(0, prev - 1))}
//                     disabled={currentQuestionIndex === 0}
//                     className="flex-1 px-4 py-2 border-2 border-gray-600 text-gray-300 rounded-lg font-semibold hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed text-xs sm:text-sm"
//                   >
//                     Previous
//                   </button>
...
//                     <button
//                       onClick={handleSubmit}
//                       className="flex-1 bg-gradient-to-t from-green-600 to-green-400 text-white px-6 py-2 rounded-lg font-semibold hover:from-green-700 hover:to-green-500 text-xs sm:text-sm"
//                     >
//                       Submit
//                     </button>
//                   ) : (
//                     <button
//                       onClick={() => setCurrentQuestionIndex(prev => Math.min(questions.length - 1, prev + 1))}
//                       className="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 text-white px-6 py-2 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-500 text-xs sm:text-sm"
//                     >
//                       Next
//                     </button>
//                   )}
...
//             <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6">
//               <div>
//                 <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white">{assignment.assignmentData?.title || 'Assignment'}</h3>
//                 <p className="text-xs sm:text-sm text-gray-400">Course: {course?.title}</p>
//                 {assignment.free && !isEnrolled(course.id) && (
//                   <span className="mt-1 inline-block text-xs bg-green-500/20 text-green-400 px-2 py-1 rounded-full">
//                     Free Preview
//                   </span>
...
//             {submitted ? (
//               <div className="text-center py-8">
//                 <CheckCircleIcon className="text-5xl sm:text-6xl text-green-400 mb-4" />
//                 <h4 className="text-lg sm:text-xl font-bold text-white mb-2">Assignment Submitted!</h4>
//                 <p className="text-sm sm:text-base text-gray-400 mb-6">Your instructor will review your submission.</p>
//                 <button
//                   onClick={() => setActiveModal(null)}
//                   className="bg-gradient-to-t from-blue-600 to-blue-400 text-white px-6 py-2 rounded-lg font-semibold text-sm sm:text-base"
//                 >
//                   Close
//                 </button>
//               </div>
...
//                 {/* Description */}
//                 <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700 mb-6">
//                   <h4 className="text-sm sm:text-base font-semibold text-white mb-2">Instructions</h4>
//                   <p className="text-xs sm:text-sm text-gray-300 mb-4">{assignment.assignmentData?.description}</p>

//                   <h5 className="text-sm sm:text-base font-semibold text-white mb-2">Steps:</h5>
//                   <ul className="list-disc list-inside space-y-1 mb-4">
//                     {assignment.assignmentData?.instructions.map((inst, idx) => (
//                       <li key={idx} className="text-xs sm:text-sm text-gray-300">{inst}</li>
//                     ))}
//                   </ul>

//                   {assignment.assignmentData?.resources && (
//                     <>
//                       <h5 className="text-sm sm:text-base font-semibold text-white mb-2">Resources:</h5>
//                       <div className="flex flex-wrap gap-2">
//                         {assignment.assignmentData.resources.map((res, idx) => (
//                           <span key={idx} className="text-xs bg-gray-700 text-blue-400 px-2 py-1 rounded-full">
//                             {res}
...
//                         onChange={(e) => setGithubUrl(e.target.value)}
//                         placeholder="https://github.com/username/repo"
//                         className="w-full px-4 py-3 bg-gray-800 border border-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
//                       />
//                     </div>
//                   )}
...
//                       multiple
//                       onChange={handleFileUpload}
//                       className="w-full px-4 py-3 bg-gray-800 border border-gray-700 text-white rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:sm:text-sm file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700"
//                     />
//                     {files.length > 0 && (
//                       <div className="mt-2 space-y-1">
//                         {files.map((file, idx) => (
...
//                     onClick={handleSubmit}
//                     disabled={assignment.assignmentData?.submissionType === 'github' && !githubUrl}
//                     className="w-full bg-gradient-to-t from-green-600 to-green-400 text-white py-3 rounded-lg font-semibold hover:from-green-700 hover:to-green-500 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
//                   >
//                     Submit Assignment
//                   </button>
//                 </div>
...
//           <div className="flex flex-col lg:flex-row">
//             {/* Left side - Course Info */}
//             <div className={`lg:w-1/2 bg-gradient-to-t from-${course.color}-600 to-${course.color}-800 p-6 sm:p-8`}>
//               <div className="text-center text-white">
//                 <SchoolIcon sx={{ fontSize: 60 }} className="mb-4" />
//                 <h2 className="text-2xl sm:text-3xl font-bold mb-4">Enroll in Course</h2>
//                 <p className="text-lg sm:text-xl mb-2 line-clamp-2">{course.title}</p>
//                 <p className="text-base sm:text-lg opacity-90 mb-4">with {course.instructor}</p>
...
//                   <div className="flex items-center gap-2">
//                     <CheckCircleIcon className="text-green-300 w-5 h-5 flex-shrink-0" />
//                     <span>Full lifetime access</span>
//                   </div>
//                   <div className="flex items-center gap-2">
//                     <CheckCircleIcon className="text-green-300 w-5 h-5 flex-shrink-0" />
...
//             {/* Right side - Enrollment Form */}
//             <div className="lg:w-1/2 p-6 sm:p-8 bg-gray-900">
//               <div className="flex justify-between items-center mb-6">
...
//               <div className="flex items-center justify-between mb-8">
//                 <div className={`flex-1 h-1 ${step >= 1 ? 'bg-blue-500' : 'bg-gray-700'}`}></div>
//                 <div className={`mx-2 w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold ${
//                   step >= 1 ? 'bg-blue-500 text-white' : 'bg-gray-700 text-gray-400'
//                 }`}>1</div>
//                 <div className={`flex-1 h-1 ${step >= 2 ? 'bg-blue-500' : 'bg-gray-700'}`}></div>
//                 <div className={`mx-2 w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold ${
...
//                       type="button"
//                       onClick={() => setStep(1)}
//                       className="flex-1 border-2 border-gray-600 text-gray-300 py-3 rounded-lg font-semibold hover:bg-gray-800 text-sm sm:text-base"
//                     >
//                       Back
//                     </button>
//                   )}
//                   <button
//                     type="submit"
//                     className={`flex-1 bg-gradient-to-t from-green-600 to-green-400 text-white py-3 rounded-lg font-semibold hover:from-green-700 hover:to-green-500 text-sm sm:text-base ${
//                       step === 1 ? 'w-full' : ''
//                     }`}
//                   >
//                     {step === 1 ? 'Continue to Payment' : `Pay $${course.price}`}
...
//               </button>
//               <div className="text-2xl sm:text-3xl">{course.image}</div>
//               <div className="hidden sm:block">
//                 <h2 className="text-base sm:text-lg md:text-xl font-bold text-white">{course.title}</h2>
//                 <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-400">
//                   <span>Progress: {courseProgress}%</span>
//                   <div className="w-20 sm:w-32 h-2 bg-gray-700 rounded-full">
//                     <div
//                       className="h-full bg-green-500 rounded-full"
//                       style={{ width: `${courseProgress}%` }}
//                     ></div>
...
//           {/* Mobile Course Title */}
//           <div className="sm:hidden bg-gray-800/50 p-3 border-b border-gray-700">
//             <h2 className="text-sm font-bold text-white">{course.title}</h2>
...
//             {/* Sidebar - Curriculum */}
//             <div className={`
//               absolute lg:relative inset-y-0 left-0 z-20 w-64 sm:w-72 lg:w-80 bg-gray-900 border-r border-gray-800 overflow-y-auto transform transition-transform duration-300
...
//                     >
//                       <div className="flex items-center gap-2 truncate pr-2">
//                         <MenuBookIcon className="text-blue-400 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />
//                         <span className="text-xs sm:text-sm text-white font-semibold truncate">{section.section}</span>
//                       </div>
...
//                             }}
//                             className={`w-full p-2 pl-8 flex items-center gap-2 hover:bg-gray-700 ${
//                               activeLecture?.id === lecture.id ? 'bg-blue-600/20' : ''
//                             }`}
//                           >
//                             {lecture.type === 'video' && (
...
//                                 <PlayCircleIcon className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0" />
//                             )}
//                             {lecture.type === 'pdf' && (
//                               <PictureAsPdfIcon className="w-3 h-3 sm:w-4 sm:h-4 text-red-400 flex-shrink-0" />
//                             )}
//                             {lecture.type === 'quiz' && <QuizIcon className="w-3 h-3 sm:w-4 sm:h-4 text-purple-400 flex-shrink-0" />}
//                             {lecture.type === 'assignment' && <AssignmentIcon className="w-3 h-3 sm:w-4 sm:h-4 text-orange-400 flex-shrink-0" />}
...
//                       <h3 className="text-sm sm:text-base text-white font-semibold">{activeLecture.title}</h3>
//                       <p className="text-xs text-gray-400 mt-1">{activeLecture.description}</p>
//                       {activeLecture.free && (
//                         <p className="text-xs text-green-400 mt-1">Free Preview</p>
//                       )}
//                     </div>
...
//                     <Modals.Quiz quiz={activeLecture} course={course} />
//                   </div>
//                 ) : (
//                   <div className="h-full overflow-y-auto p-4">
//                     <Modals.Assignment assignment={activeLecture} course={course} />
//                   </div>
//                 )
//               ) : (
//                 <div className="h-full flex items-center justify-center text-gray-500 text-sm sm:text-base p-4 text-center">
//                   Select a lecture to start learning
//                 </div>
//               )}
//             </div>
...
//       <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden pt-20">
//         <div className="absolute inset-0 opacity-5">
//           <div className="absolute top-0 left-0 w-48 sm:w-64 md:w-96 h-48 sm:h-64 md:h-96 bg-blue-500 rounded-full filter blur-3xl"></div>
//           <div className="absolute bottom-0 right-0 w-64 sm:w-80 md:w-[500px] h-64 sm:h-80 md:h-[500px] bg-purple-600 rounded-full filter blur-3xl"></div>
//         </div>
...
//             className="text-center max-w-4xl mx-auto"
//           >
//             <span className="inline-block px-3 sm:px-4 py-1 sm:py-2 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-full text-blue-400 font-semibold text-xs sm:text-sm mb-4 sm:mb-6 border border-blue-500/30">
//               Our Courses
//             </span>
...
//                   setActiveModal('learning');
//                 }}
//                 className="bg-gradient-to-t from-green-600 to-green-400 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full font-semibold text-sm sm:text-base hover:from-green-700 hover:to-green-500 transition-all duration-300 shadow-lg inline-flex items-center gap-2"
//               >
//                 <PlayLessonIcon className="w-4 h-4 sm:w-5 sm:h-5" />
...
//       {/* Search and Filters */}
//       <section className="bg-gradient-to-b from-gray-900 to-black py-4 sm:py-6 md:py-8 border-y border-gray-800 sticky top-16 z-40">
//         <div className="container mx-auto px-4">
...
//                   value={searchQuery}
//                   onChange={(e) => setSearchQuery(e.target.value)}
//                   className="w-full pl-9 sm:pl-10 pr-4 py-2 sm:py-3 bg-gray-800 border border-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 text-sm sm:text-base"
//                 />
//               </div>
//             </div>
...
//                 value={selectedCategory}
//                 onChange={(e) => setSelectedCategory(e.target.value)}
//                 className="flex-1 sm:flex-none px-3 sm:px-4 py-2 sm:py-3 bg-gray-800 border border-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs sm:text-sm"
//               >
//                 {categories.map(cat => (
//                   <option key={cat.id} value={cat.id}>{cat.name}</option>
//                 ))}
...
//       {/* Enrolled Courses Section */}
//       {enrolledCourses.length > 0 && (
//         <section className="bg-gradient-to-b from-black to-gray-900 py-8 sm:py-12">
//           <div className="container mx-auto px-4">
//             <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center gap-2">
//               <PlayLessonIcon className="text-green-400 w-5 h-5 sm:w-6 sm:h-6" />
//               My Learning
//             </h2>
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
//               {coursesData.filter(c => enrolledCourses.includes(c.id)).map(course => (
//                 <div key={course.id} className="bg-gray-800 rounded-lg p-3 sm:p-4 border border-gray-700 flex items-center gap-3 sm:gap-4">
//                   <div className={`text-2xl sm:text-3xl md:text-4xl bg-gradient-to-br from-${course.color}-600 to-${course.color}-800 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-lg flex items-center justify-center flex-shrink-0`}>
//                     {course.image}
//                   </div>
//                   <div className="flex-1 min-w-0">
//                     <h3 className="text-white font-semibold text-xs sm:text-sm truncate">{course.title}</h3>
//                     <div className="flex items-center gap-2 mt-1">
//                       <div className="flex-1 h-1 bg-gray-700 rounded-full">
//                         <div
//                           className="h-full bg-green-500 rounded-full"
...
//                         ></div>
//                       </div>
//                       <span className="text-xs text-gray-400 flex-shrink-0">{getCourseProgress(course.id)}%</span>
//                     </div>
//                   </div>
//                   <button
//                     onClick={() => {
...
//       {/* Free Preview Banner */}
//       {freePreviewOnly && (
//         <div className="bg-gradient-to-r from-green-600 to-green-800 py-2 sm:py-3">
//           <div className="container mx-auto px-4 text-center text-white">
...
//               >
//                 {/* Course Image */}
//                 <div className={`bg-gradient-to-br from-${course.color}-600 to-${course.color}-800 p-4 sm:p-6 relative`}>
//                   <div className="text-4xl sm:text-5xl md:text-6xl text-center">{course.image}</div>
//                   {course.badge && (
//                     <span className={`absolute top-2 sm:top-4 right-2 sm:right-4 px-2 py-1 bg-${course.badgeColor}-500/20 text-${course.badgeColor}-400 rounded-full text-xs font-semibold`}>
//                       {course.badge}
//                     </span>
//                   )}
//                   {isEnrolled(course.id) && (
//                     <span className="absolute top-2 sm:top-4 left-2 sm:left-4 px-2 py-1 bg-green-500/20 text-green-400 rounded-full text-xs font-semibold">
//                       Enrolled
//                     </span>
//                   )}
//                   {course.freePreview && !isEnrolled(course.id) && (
//                     <span className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4 px-2 py-1 bg-green-500/20 text-green-400 rounded-full text-xs font-semibold">
//                       Free Preview
//                     </span>
//                   )}
//                 </div>
...
//                     <span className={`text-${course.color}-400 text-xs sm:text-sm font-semibold`}>
//                       {categories.find(c => c.id === course.category)?.name}
//                     </span>
//                     <span className="text-gray-500">•</span>
//                     <span className="text-gray-400 text-xs sm:text-sm">{course.level}</span>
//                   </div>
...
//                   <p className="text-gray-400 text-xs sm:text-sm mb-4 line-clamp-2">{course.description}</p>

//                   {/* Instructor */}
//                   <div className="flex items-center gap-2 mb-4">
//                     <div className={`w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-gradient-to-br from-${course.color}-500 to-${course.color}-600 flex items-center justify-center text-xs text-white font-bold flex-shrink-0`}>
//                       {course.instructorImage}
//                     </div>
//                     <span className="text-xs sm:text-sm text-gray-300 truncate">{course.instructor}</span>
//                   </div>
...
//                     <div className="flex">
//                       {[1, 2, 3, 4, 5].map((star) => (
//                         <StarIcon key={star} className={`w-3 h-3 sm:w-4 sm:h-4 ${star <= Math.floor(course.rating) ? 'text-yellow-400' : 'text-gray-600'}`} />
//                       ))}
//                     </div>
//                     <span className="text-xs sm:text-sm text-gray-300">{course.rating}</span>
//                     <span className="text-xs sm:text-sm text-gray-500 hidden sm:inline">({course.students.toLocaleString()})</span>
//                   </div>

//                   {/* Course Stats */}
//                   <div className="flex items-center justify-between text-xs sm:text-sm text-gray-400 mb-4">
//                     <div className="flex items-center gap-1">
//                       <MenuBookIcon className="w-3 h-3 sm:w-4 sm:h-4" />
//                       <span>{course.lectures}</span>
//                     </div>
//                     <div className="flex items-center gap-1">
//                       <AccessTime className="w-3 h-3 sm:w-4 sm:h-4" />
//                       <span>{course.duration}</span>
//                     </div>
//                   </div>
...
//                       <>
//                         <div>
//                           <span className="text-lg sm:text-xl md:text-2xl font-bold text-white">${course.price}</span>
//                           <span className="text-xs sm:text-sm text-gray-400 line-through ml-1 sm:ml-2">${course.originalPrice}</span>
//                         </div>
//                         <button
//                           onClick={(e) => {
//                             e.stopPropagation();
...
//                             setActiveModal('enroll');
//                           }}
//                           className="bg-gradient-to-t from-blue-600 to-blue-400 text-white px-3 sm:px-4 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-semibold hover:from-blue-700 hover:to-blue-500 transition-all duration-300"
//                         >
//                           Enroll
//                         </button>
//                       </>
...
//                             setActiveModal('learning');
//                           }}
//                           className="bg-gradient-to-t from-green-600 to-green-400 text-white px-3 sm:px-4 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-semibold hover:from-green-700 hover:to-green-500"
//                         >
//                           Continue
//                         </button>
//                       </>
...
//               <p className="text-gray-400 text-sm sm:text-base lg:text-lg">No courses found matching your criteria.</p>
//             </div>
//           )}
...
//                   onClick={() => paginate(currentPage - 1)}
//                   disabled={currentPage === 1}
//                   className="px-2 sm:px-4 py-1 sm:py-2 bg-gray-800 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-700 transition-colors text-xs sm:text-sm"
//                 >
//                   Previous
//                 </button>
...
export const Courses = () => {
  ...
  const samplePDFs = [
    ...
    },
    {
      ...
      size: "1.1MB",
      free: true,
      description: "Understand styling and layout techniques",
    },
    {
      id: "js",
      title: "JavaScript Basics",
    ...
    },
    {
      ...
      size: "2.5MB",
      free: false,
      description: "Learn arrays, stacks, queues, trees",
    },
    {
      id: "react",
      title: "React Guide",
      url: "https://unec.edu.az/application/uploads/2019/12/react.pdf",
      type: "pdf",
      size: "3MB",
      free: true,
    ...
    },
    {
      ...
      size: "4MB",
      free: false,
      description: "Deep dive into JS patterns",
    },
    {
      id: "node",
      title: "Node.js Best Practices",
      url: "https://github.com/goldbergyoni/nodebestpractices/raw/master/README.md.pdf",
      type: "pdf",
      size: "2MB",
      free: false,
      description: "Backend best practices with Node.js",
    },
    {
      id: "db",
      title: "Database Design Fundamentals",
      url: "https://www.tutorialspoint.com/dbms/dbms_tutorial.pdf",
      type: "pdf",
      size: "1.8MB",
      free: false,
    ...
    },
    {
      ...
      url: "https://www.tutorialspoint.com/restful/restful_tutorial.pdf",
      type: "pdf",
      size: "1.6MB",
      free: true,
    ...
    },
    {
      ...
      url: "https://github.com/donnemartin/system-design-primer/raw/master/README.md.pdf",
      type: "pdf",
      size: "5MB",
      free: false,
    ...
    },
    {
      ...
      url: "https://www.atlassian.com/devops/what-is-devops/devops-handbook.pdf",
      type: "pdf",
      size: "3MB",
      free: false,
      description: "CI/CD and DevOps culture",
    },
  ];
  ...
  const coursesData = [
    {
      ...
      color: "blue",
      description:
        "Master full-stack web development with HTML, CSS, JavaScript, React, Node.js, and MongoDB. Build 15+ real-world projects.",
      longDescription:
        "This comprehensive bootcamp covers everything you need to become a professional web developer. From front-end fundamentals to back-end architecture, you'll learn through hands-on projects and real-world scenarios.",
      whatYoullLearn: [
        "Build 15+ complete web applications",
        "Master HTML5, CSS3, and JavaScript ES6+",
        "Create responsive designs with Flexbox and Grid",
      ...
      curriculum: [
        {
          ...
          lectures: [
            ...
            },
            {
              ...
              youtubeId: "hJHvdBlSxug",
              description:
                "Understanding the basics of how the internet functions.",
            },
            {
              id: "1-3",
              title: "Introduction to HTML - Free PDF",
            ...
            },
            {
              ...
              youtubeId: "c2AwTtW3T48",
              description:
                "Install and configure VS Code, Git, and necessary tools.",
            },
            {
              id: "1-5",
              title: "Introduction to HTML",
    ...
    },
    {
      ...
      color: "purple",
      description:
        "Master Python, SQL, machine learning algorithms, and data visualization. Build real-world data projects.",
      longDescription:
        "This comprehensive data science program takes you from Python basics to advanced machine learning. Learn to analyze data, build predictive models, and communicate insights effectively.",
      freePreview: {
        video: "YYXdXT2l-Gg",
        pdf: samplePDFs[3],
        quiz: true,
    ...
    },
    {
      ...
      color: "green",
      description:
        "Build iOS and Android apps with Flutter and React Native. Publish to App Store and Google Play.",
      freePreview: {
        video: "fq4N0hgOWzU",
        pdf: samplePDFs[4],
        quiz: true,
    ...
    },
    {
      ...
      color: "red",
      description:
        "Master ethical hacking, penetration testing, network security, and incident response.",
      freePreview: {
        video: "fNzpcB7ODxQ",
        pdf: samplePDFs[5],
        quiz: true,
    ...
    },
    {
      ...
      color: "cyan",
      description:
        "Master AWS, Azure, Google Cloud, Docker, Kubernetes, and DevOps practices.",
      freePreview: {
        video: "M988_fsOSWo",
        pdf: samplePDFs[0],
        quiz: true,
    ...
    },
    {
      ...
      color: "orange",
      description:
        "Master deep learning, neural networks, NLP, computer vision, and generative AI.",
      freePreview: {
        video: "aircAruvnKk",
        pdf: samplePDFs[1],
        quiz: true,
    ...
    // Additional courses to reach 12 total
    {
      ...
      color: "cyan",
      description:
        "Master advanced React patterns, Next.js 14, server components, and full-stack development.",
      freePreview: {
        video: "Ke90Tje7VS0",
        pdf: samplePDFs[2],
        quiz: true,
      ...
      curriculum: [
        {
          ...
          lectures: [
            {
              id: "1-1",
              title: "Advanced Hooks Deep Dive",
              duration: "35:20",
              type: "video",
              free: true,
              youtubeId: "TNhaISOUy6Q",
    ...
    },
    {
      ...
      color: "green",
      description:
        "Master data analysis with Python, Pandas, NumPy, and visualization libraries.",
      freePreview: {
        video: "vmEHCJofslg",
        pdf: samplePDFs[3],
        quiz: true,
    ...
    },
    {
      ...
      color: "gray",
      description:
        "Build iOS apps with SwiftUI. Learn Swift, SwiftUI, Combine, and Core Data.",
      freePreview: {
        video: "HXoVSllLLeI",
        pdf: samplePDFs[4],
        quiz: true,
    ...
    },
    {
      ...
      color: "indigo",
      description:
        "Master network security, firewalls, VPNs, and intrusion detection systems.",
      freePreview: {
        video: "qiQR5rTSshw",
        pdf: samplePDFs[5],
        quiz: true,
    ...
    },
    {
      ...
      color: "teal",
      description:
        "Master NLP with Python, NLTK, spaCy, transformers, and BERT.",
      freePreview: {
        video: "fL1J9xMqRjM",
        pdf: samplePDFs[1],
        quiz: true,
    ...
    if (selectedCourse) {
      setCourseProgress((prev) => ({
        ...
        [selectedCourse.id]: {
          ...prev[selectedCourse.id],
          completedLectures:
            (prev[selectedCourse.id]?.completedLectures || 0) + 1,
        },
      }));
    }
  ...
  // Handle PDF viewing
  const openPdf = (pdf) => {
    console.log("Opening PDF:", pdf); // Debug log
    setCurrentPdf(pdf);
    setActiveModal("pdf");
  };

  // Function to find free PDF in course
  const findFreePdf = (course) => {
    // Try to find free PDF in downloads first
    let previewPdf = null;

    // Check in downloads array
    if (Array.isArray(course.downloads)) {
      previewPdf = course.downloads.find((d) => d.free);
      if (previewPdf) {
        console.log("Found PDF in downloads:", previewPdf);
        return previewPdf;
      }
    }

    // If not found in downloads, check in curriculum lectures
    if (Array.isArray(course.curriculum)) {
      for (const section of course.curriculum) {
        const pdfLecture = section.lectures?.find(
          (l) => l.type === "pdf" && l.free,
        );
        if (pdfLecture) {
          console.log("Found PDF in curriculum:", pdfLecture);
          return pdfLecture;
        }
      }
    }

    // If still not found, check freePreview.pdf
    if (course.freePreview?.pdf) {
      console.log("Found PDF in freePreview:", course.freePreview.pdf);
      return course.freePreview.pdf;
    }

    console.log("No free PDF found for course");
    return null;
  };
  ...
  const Modals = {
    CourseDetail: ({ course }) => (
      ...
      >
        ...
        <div className="overflow-y-auto flex-1">
          {/* Course Header - Not Sticky */}
          <div
            className={`bg-gradient-to-r from-${course.color}-600 to-${course.color}-800 p-4 sm:p-6 md:p-8`}
          >
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
                    <span
                      className={`px-2 sm:px-3 py-1 bg-${course.badgeColor}-500/20 text-${course.badgeColor}-400 rounded-full text-xs font-semibold`}
                    >
                      {course.badge}
                    </span>
                    <span className="flex items-center gap-1 text-white text-sm sm:text-base">
                  ...
                  <p className="text-sm sm:text-base text-white/80 line-clamp-2 sm:line-clamp-none">
                    {course.description}
                  </p>
                </div>
              </div>
            ...
            {course.freePreview && (
              <div className="mt-4 sm:mt-6 bg-white/10 rounded-xl p-3 sm:p-4">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  <button
                    onClick={() => {
                      const previewLecture = course.curriculum[0].lectures.find(
                        (l) => l.free && l.type === "video",
                      );
                      if (previewLecture) {
                        setSelectedLesson(previewLecture);
                        setSelectedCourse(course);
                  ...
                  <button
                    onClick={() => {
                      const previewPdf = findFreePdf(course);
                      if (previewPdf) {
                        openPdf(previewPdf);
                      } else {
                        toast.info("No free PDF available for this course");
                      }
                    }}
                    className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 rounded-lg text-sm transition-colors"
                  >
                  ...
                  <button
                    onClick={() => {
                      const previewQuiz = course.curriculum[0].lectures.find(
                        (l) => l.free && l.type === "quiz",
                      );
                      if (previewQuiz) {
                        setSelectedLesson(previewQuiz);
                        setCurrentQuiz(previewQuiz);
                        ...
                        toast.info("No free quiz available for this course");
                      }
                    }}
                    className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-3 sm:px-4 py-2 rounded-lg text-sm transition-colors"
                  >
          ...
          <div className="p-4 sm:p-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                    {course.whatYoullLearn.slice(0, 6).map((item, index) => (
                      <div key={index} className="flex items-start gap-2">
                        <CheckCircleIcon
                          className={`text-${course.color}-400 w-4 h-4 sm:w-5 sm:h-5 mt-0.5 flex-shrink-0`}
                        />
                ...
                {course.curriculum.map((section, sectionIndex) => (
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-2 truncate pr-2">
                        <MenuBookIcon
                          className={`text-${course.color}-400 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0`}
                        />
                          ...
                          {section.lectures.map((lecture, lectureIndex) => (
                            ...
                            >
                              <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                                ...
                                {lecture.type === "quiz" && (
                                  <QuizIcon className="text-purple-400 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />
                                )}
                                {lecture.type === "assignment" && (
                                  <AssignmentIcon className="text-orange-400 w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />
                                )}
                                <div className="min-w-0">
                                  <span className="text-xs sm:text-sm text-white truncate block">
                                    {lecture.title}
                                  </span>
                                  <div className="flex flex-wrap items-center gap-1 sm:gap-2 mt-1">
                                    {lecture.type === "video" && (
                ...
                <div className="space-y-3 sm:space-y-4">
                  {Object.keys(notes).length > 0 ? (
                    ...
                    <p className="text-sm sm:text-base text-gray-400">
                      No notes yet. Start watching and take notes!
                    </p>
                  )}
                </div>
              </div>
            ...
            {activeTab === "downloads" && (
              <div>
                ...
                <div className="grid gap-2 sm:gap-3">
                  {Array.isArray(course.downloads) &&
                    course.downloads.map((dl, index) => (
                      <div
                        key={index}
                        className="bg-gray-800 rounded-lg p-3 sm:p-4 border border-gray-700 flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                      >
                        <div className="flex items-center gap-3">
                          {dl.type === "pdf" ? (
                            <PictureAsPdfIcon className="text-red-400 w-5 h-5 sm:w-6 sm:h-6" />
                          ) : (
                            <InsertDriveFileIcon className="text-blue-400 w-5 h-5 sm:w-6 sm:h-6" />
                          )}
                          <div>
                            ...
                            {dl.free && (
                              <span className="mt-1 inline-block text-xs bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full">
                                Free
                              </span>
                            )}
                          </div>
          ...
          <div className="flex flex-col lg:flex-row h-[90vh]">
            ...
            <div className="lg:w-1/4 bg-gray-900 border-t lg:border-t-0 lg:border-l border-gray-800 flex flex-col h-64 lg:h-auto">
              ...
              <div className="flex-1 overflow-y-auto p-3 sm:p-4">
                ...
                {/* Notes List */}
                <div className="space-y-3">
                  <h5 className="text-xs sm:text-sm font-semibold text-gray-400">
                    Saved Notes
                  </h5>
                  {lectureNotes.length > 0 ? (
                    lectureNotes.map((note, index) => (
    ...
    Quiz: ({ quiz, course }) => {
      ...
      const [timeLeft, setTimeLeft] = useState(
        quiz.duration ? parseInt(quiz.duration) * 60 : 900,
      );
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6">
              ...
              {!showResults && (
                <div className="flex items-center gap-2 text-base sm:text-xl font-bold">
                  <TimerIcon className="text-yellow-400 w-4 h-4 sm:w-5 sm:h-5" />
                  <span
                    className={timeLeft < 300 ? "text-red-400" : "text-white"}
                  >
                    {formatTime(timeLeft)}
                  </span>
                </div>
            ...
            {showResults ? (
              ...
              <div className="text-center py-6 sm:py-8">
                <div className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">
                  <span
                    className={score >= 70 ? "text-green-400" : "text-red-400"}
                  >
                    {score}%
                  </span>
                </div>
                      ...
                      (option, optIndex) => (
                        ...
                        >
                          <input
                            ...
                            checked={answers[currentQuestionIndex] === optIndex}
                            onChange={() =>
                              handleAnswer(currentQuestionIndex, optIndex)
                            }
                            className="hidden"
                          />
                          <div
                            className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 mr-3 flex items-center justify-center flex-shrink-0 ${
                              answers[currentQuestionIndex] === optIndex
                                ? "border-blue-500 bg-blue-500"
                                : "border-gray-400"
                            }`}
            ...
            {submitted ? (
              ...
              <>
                ...
                <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700 mb-6">
                  ...
                  <h5 className="text-sm sm:text-base font-semibold text-white mb-2">
                    Steps:
                  </h5>
                  <ul className="list-disc list-inside space-y-1 mb-4">
                    {assignment.assignmentData?.instructions.map(
                      (inst, idx) => (
                        <li
                          key={idx}
      ...
      return (
        ...
        >
          <div className="flex flex-col lg:flex-row">
            {/* Left side - Course Info */}
            <div
              className={`lg:w-1/2 bg-gradient-to-t from-${course.color}-600 to-${course.color}-800 p-6 sm:p-8`}
            >
              <div className="text-center text-white">
                <SchoolIcon sx={{ fontSize: 60 }} className="mb-4" />
                ...
                <p className="text-lg sm:text-xl mb-2 line-clamp-2">
                  {course.title}
                </p>
            ...
            <div className="lg:w-1/2 p-6 sm:p-8 bg-gray-900">
              ...
              <div className="flex items-center justify-between mb-8">
                <div
                  className={`flex-1 h-1 ${step >= 1 ? "bg-blue-500" : "bg-gray-700"}`}
                ></div>
                <div
                  className={`mx-2 w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold ${
                    step >= 1
                ...
                <div
                  className={`flex-1 h-1 ${step >= 2 ? "bg-blue-500" : "bg-gray-700"}`}
                ></div>
                <div
                  className={`mx-2 w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold ${
                    step >= 2
                ...
                <div
                  className={`flex-1 h-1 ${step >= 3 ? "bg-blue-500" : "bg-gray-700"}`}
                ></div>
              </div>
                      ...
                      <div className="bg-gray-800/50">
                        {section.lectures.map((lecture, lIndex) => (
                          ...
                          >
                            ...
                            {lecture.type === "quiz" && (
                              <QuizIcon className="w-3 h-3 sm:w-4 sm:h-4 text-purple-400 flex-shrink-0" />
                            )}
                            {lecture.type === "assignment" && (
                              <AssignmentIcon className="w-3 h-3 sm:w-4 sm:h-4 text-orange-400 flex-shrink-0" />
                            )}
                            <span className="text-xs text-gray-300 truncate flex-1 text-left">
                              {lecture.title}
                            </span>
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-4 py-12 sm:py-16 relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8 max-w-3xl mx-auto px-4">
              Master in-demand skills with our comprehensive courses. Learn at
              your own pace with video lectures, hands-on projects, and
              personalized support. Try free previews before enrolling!
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {coursesData
                ...
                .map((course) => (
                  <div
                    key={course.id}
                    className="bg-gray-800 rounded-lg p-3 sm:p-4 border border-gray-700 flex items-center gap-3 sm:gap-4"
                  >
                    <div
                      className={`text-2xl sm:text-3xl md:text-4xl bg-gradient-to-br from-${course.color}-600 to-${course.color}-800 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-lg flex items-center justify-center flex-shrink-0`}
                    >
                      {course.image}
                    </div>
                    <div className="flex-1 min-w-0">
      ...
      {freePreviewOnly && (
        <div className="bg-gradient-to-r from-green-600 to-green-800 py-2 sm:py-3">
          <div className="container mx-auto px-4 text-center text-white">
            <p className="flex items-center justify-center gap-2 text-xs sm:text-sm">
              <PlayCircleIcon className="w-4 h-4 sm:w-5 sm:h-5" />
              Showing courses with free preview content. Click on any course to
              try before you buy!
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {currentCourses.map((course, index) => (
              ...
              >
                {/* Course Image */}
                <div
                  className={`bg-gradient-to-br from-${course.color}-600 to-${course.color}-800 p-4 sm:p-6 relative`}
                >
                  ...
                  {course.badge && (
                    <span
                      className={`absolute top-2 sm:top-4 right-2 sm:right-4 px-2 py-1 bg-${course.badgeColor}-500/20 text-${course.badgeColor}-400 rounded-full text-xs font-semibold`}
                    >
                      {course.badge}
                    </span>
                  )}
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span
                      className={`text-${course.color}-400 text-xs sm:text-sm font-semibold`}
                    >
                      {categories.find((c) => c.id === course.category)?.name}
                    </span>
                    <span className="text-gray-500">•</span>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <div
                      className={`w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-gradient-to-br from-${course.color}-500 to-${course.color}-600 flex items-center justify-center text-xs text-white font-bold flex-shrink-0`}
                    >
                      {course.instructorImage}
                    </div>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <div className="flex">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <StarIcon
                          key={star}
                          className={`w-3 h-3 sm:w-4 sm:h-4 ${star <= Math.floor(course.rating) ? "text-yellow-400" : "text-gray-600"}`}
                        />
                      ))}
                    </div>
                    <span className="text-xs sm:text-sm text-gray-300">
                    ...
                    <div className="flex gap-2 mb-4">
                      <button
                        onClick={(e) => {
                          ...
                          const previewLecture =
                            course.curriculum[0].lectures.find(
                              (l) => l.free && l.type === "video",
                            );
                          if (previewLecture) {
                            setSelectedLesson(previewLecture);
                      ...
                      <button
                        onClick={(e) => {
                          ...
                          // Try to find free PDF in multiple locations
                          const previewPdf = findFreePdf(course);
        ...
        {activeModal && (
          ...
          >
            <div onClick={(e) => e.stopPropagation()}>
              ...
              {activeModal === "pdf" && <Modals.PDFViewer pdf={currentPdf} />}
              {activeModal === "quiz" && (
                <Modals.Quiz quiz={selectedLesson} course={selectedCourse} />
              )}
              ...
              {activeModal === "enroll" && (
                <Modals.Enroll course={selectedCourse} />
              )}
              {activeModal === "learning" && (
                <Modals.Learning course={selectedCourse} />
              )}
            </div>
          </motion.div>
        )}
